  ...
  return (
    ...
    >
      <article className="bg-white border rounded-lg max-w-[500px] w-[95%] pb-4 shadow relative ">
        ...
        <div className="p-4">
          <p className="text-sm text-[#686868] font-mono text-center">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae
            numquam a minus culpa{" "}
          </p>
        </div>
        <div className="grid place-items-center text-sm space-y-3 w-full  ">
          <Link href={"/auth/login"} className="w-[90%] mx-auto ">
            <button
              className=" w-full py-1 bg-[#3b49de] text-white rounded shadow"
              onClick={() => setOpenLoginModal(false)}
            >
              Login
            </button>
          ...
          <Link href={"/auth/register"} className="w-[90%]">
            <button
